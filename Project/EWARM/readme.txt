...
/******************************************************************************
  stm32103系列从32K到512K字节的闪存程序存储器（STM32F103XXXX中的第二个X表示FLASH容量，
其中：“4”=16K，“6”=32K，“8”=64K，B=128K，C=256K，D=384K，E=512K）
  Flash的大小可分为三大类：小容量（16K和32K）、中容量（64K和128K）、大容量（256K、384K和512K）
